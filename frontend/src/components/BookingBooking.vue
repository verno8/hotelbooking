<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-title v-if="value._links">
            Booking # {{decode(value._links.self.href.split("/")[value._links.self.href.split("/").length - 1])}}
        </v-card-title >
        <v-card-title v-else>
            Booking
        </v-card-title >        
        ...
        <v-card-text>
            ...
            <Date label="BookDt" v-model="value.bookDt" :editMode="editMode" :inputUI="''"/>
            <String label="BookStatus" v-model="value.bookStatus" :editMode="editMode" :inputUI="''"/>
        </v-card-text>
